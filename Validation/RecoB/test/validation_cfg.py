...
if whichJets=="ak5PFnoPU":
    ...
    process.pfPileUpPF2PAT.Vertices = cms.InputTag('mygoodOfflinePrimaryVertices')
...
if whichJets=="ak5PF":
    process.jetSequences = cms.Sequence(process.mygoodOfflinePrimaryVertices * process.btagSequence)
else:
